        ...
        <div class="grid md:grid-cols-3 gap-2">
            <div
                ...
                <h3 class="text-2xl font-bold text-[#1E293B] mb-4 group-hover:text-blue-600 transition-colors">Web
                    Development</h3>
                <p class="text-gray-600 leading-relaxed">Pembuatan website company profile, e-commerce, hingga sistem
                    informasi kustom berbasis web dengan teknologi terbaru.</p>
            </div>
            ...
            <div
                ...
                <h3 class="text-2xl font-bold text-[#1E293B] mb-4 group-hover:text-green-600 transition-colors">Mobile
                    Apps</h3>
                <p class="text-gray-600 leading-relaxed">Pengembangan aplikasi mobile berbasis Android yang responsif,
                    ringan, berkinerja tinggi, dan user-friendly.</p>
            </div>
            ...
            <div
                ...
                <h3 class="text-2xl font-bold text-[#1E293B] mb-4 group-hover:text-purple-600 transition-colors">UI/UX
                    Design</h3>
                <p class="text-gray-600 leading-relaxed">Desain antarmuka yang tidak hanya memanjakan mata, tapi juga
                    memberikan pengalaman pengguna (user experience) terbaik.</p>
            </div>
        </div>
    </div>
</section>
