    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
            ...
            <div class="relative z-10">
                ...
                <p class="text-[#1E293B] font-medium text-lg mb-10 max-w-2xl mx-auto opacity-90">Mari diskusikan ide Anda
                    bersama tim ahli kami. Konsultasi gratis, tanpa biaya tersembunyi.</p>
