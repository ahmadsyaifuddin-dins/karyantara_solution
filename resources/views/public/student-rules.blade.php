<x-public-layout>
    <x-slot name="title">{{ $title ?? 'Karyantara Solution' }}</x-slot>
    ...
    <div class="py-16 bg-gray-50 min-h-screen">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <span
                    class="bg-amber-100 text-amber-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">MoU
                    Digital</span>
                <h1 class="mt-4 text-3xl md:text-4xl font-extrabold text-[#1E293B]">Rules & Panduan Pengerjaan Skripsi
                </h1>
                <p class="mt-4 text-gray-500 max-w-2xl mx-auto">Harap baca dengan teliti poin-poin di bawah ini sebelum
                    melakukan pembayaran DP. Melakukan pembayaran berarti Anda telah menyetujui seluruh ketentuan ini.
                </p>
            </div>
            ...
            <div x-data="{ openModalRevisi: false }">
                <div class="grid md:grid-cols-2 gap-8 relative z-0">
                        ...
                        <ul class="space-y-3 text-gray-600 text-sm leading-relaxed">
                            <li class="flex items-start"><i class="fa-solid fa-check text-green-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">DP Wajib:</strong> Pengerjaan dimulai setelah
                                    pembayaran DP sebesar 25% atau 50% di awal.</span>
                            </li>
                            <li class="flex items-start"><i class="fa-solid fa-check text-green-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Pelunasan:</strong> Sisa 50% atau Sisa 75% WAJIB
                                    dilunasi saat program didemokan (video/share screen) dan SEBELUM source code
                                    dikirimkan.</span>
                            </li>
                            <li class="flex items-start"><i
                                    class="fa-solid fa-triangle-exclamation text-amber-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">DP Hangus:</strong> Jika klien membatalkan sepihak,
                                    DP tidak dapat dikembalikan, <span
                                        class="text-red-600 font-bold bg-red-50 px-1 rounded">sebagai kompensasi waktu
                                        pengerjaan</span>.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div
                        ...
                        <ul class="space-y-3 text-gray-600 text-sm leading-relaxed relative z-10">
                            <li class="flex items-start"><i class="fa-solid fa-check text-green-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Fix Alur di Awal:</strong> Pastikan konsep Aplikasi
                                    atau judul skripsi sudah FIX yang di-ACC dosen sebelum kami koding.</span>
                            </li>
                            <li class="flex items-start"><i
                                    class="fa-solid fa-xmark text-red-500 mt-1 mr-3 text-lg"></i>
                                <span><strong class="text-red-500">Ganti Judul Total:</strong> Jika dosen meminta ganti
                                    judul/konsep total di tengah jalan, terhitung sebagai <strong
                            ...
                            <li class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <span>Revisi minor (tampilan) <span class="font-bold text-[#1E293B]"> gratis 5x
                                        </span>. Penambahan fitur baru akan dikenakan *charge* tambahan.</span>
                                    <button @click="openModalRevisi = true" type="button"
                                        class="mt-2 flex items-center gap-1.5 text-[11px] font-bold text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 px-2.5 py-1.5 rounded-md transition-colors border border-blue-100">
                        ...
                        <ul class="space-y-3 text-gray-600 text-sm leading-relaxed">
                            <li class="flex items-start"><i class="fa-solid fa-check text-green-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Privasi Terjamin 100%:</strong> Kerahasiaan
                                    identitas, data penelitian, dan source code terjamin.</span>
                            </li>
                            <li class="flex items-start"><i class="fa-solid fa-check text-green-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Bukan Portofolio Publik:</strong> Kami TIDAK AKAN
                                    mempublikasikan hasil aplikasi skripsi sebagai portofolio publik tanpa izin.</span>
                            </li>
                            <li class="flex items-start"><i
                                    class="fa-solid fa-shield-halved text-blue-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Anti Jual Ulang:</strong> Kami menjamin aplikasi
                                    Anda <span class="text-red-600 font-bold">TIDAK AKAN dijual ulang</span> untuk
                                    mahasiswa lain.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div
                        ...
                        <ul class="space-y-3 text-gray-600 text-sm leading-relaxed">
                            <li class="flex items-start"><i class="fa-solid fa-check text-green-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Serah Terima:</strong> Mahasiswa mendapatkan Source
                                    Code, Database, dan dibantu instalasi ke laptop via TeamViewer/AnyDesk.</span>
                            </li>
                            <li class="flex items-start"><i
                                    class="fa-solid fa-scale-balanced text-amber-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Batas Tanggung Jawab:</strong> Kami membuat
                                    aplikasi sesuai MoU di awal. <span class="text-red-600 font-bold">Kami tidak
                                        bertanggung jawab atas revisi dosen yang memaksa alur baru di luar
                                        kesepakatan</span>.</span>
                            </li>
                            <li class="flex items-start"><i
                                    class="fa-solid fa-code-pull-request text-blue-500 mt-1 mr-3"></i>
                                <span><strong class="text-[#1E293B]">Source Code Pihak Ke-3:</strong> Jika naskah
                                    skripsi menggunakan source code dari luar, kami berhak menolak pengerjaan naskah
                                    jika logika kode di luar standar teknis kami.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <template x-teleport="body">
                    <div x-show="openModalRevisi" style="display: none;"
                        ...
                        <div @click.outside="openModalRevisi = false"
                            ...
                            <div
                                class="bg-slate-50 border-b border-gray-100 px-6 py-4 flex justify-between items-center">
                            ...
                            <div class="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
                                <div class="bg-green-50 p-4 rounded-2xl border border-green-100">
                                    ...
                                    <p class="text-xs text-green-700 leading-relaxed mb-2">Perubahan kecil UI yang
                                        tidak mengubah alur program maupun database.</p>
                                    <ol class="text-xs text-green-800 font-medium list-decimal list-inside space-y-1">
                                        <li>Mengubah warna latar/tombol</li>
                                        <li>Memperbaiki typo</li>
                                        <li>Mengganti logo aplikasi</li>
                                        <li>Menggeser posisi tabel/tombol</li>
                                    </ol>
                                </div>
                                <div class="bg-blue-50 p-4 rounded-2xl border border-blue-100">
                                    <h4 class="font-bold text-blue-800 mb-2 text-sm flex items-center gap-2">
                                        <i class="fa-solid fa-mug-hot"></i> Fitur Ringan (Charge Tambahan)
                                    </h4>
                                    <p class="text-xs text-blue-700 leading-relaxed mb-2">Fungsionalitas kecil yang
                                        memodifikasi sedikit kodingan/database.</p>
                                    <ol class="text-xs text-blue-800 font-medium list-decimal list-inside space-y-1">
                                        <li>Menambah 1 kolom input baru di form</li>
                                ...
                                <div class="bg-red-50 p-4 rounded-2xl border border-red-100">
                                    <h4 class="font-bold text-red-800 mb-2 text-sm flex items-center gap-2">
                                        <i class="fa-solid fa-triangle-exclamation"></i> Revisi Mayor (Proyek/Biaya
                                        Baru)
                                    </h4>
                                    <p class="text-xs text-red-700 leading-relaxed mb-2">Perombakan besar yang mengubah
                                        struktur dasar relasi database / algoritma.</p>
                                    <ol class="text-xs text-red-800 font-medium list-decimal list-inside space-y-1">
                                        <li>Ganti metode Algoritma (cth: AHP ke SAW)</li>
                                        <li>Menambah hak akses user role baru</li>
