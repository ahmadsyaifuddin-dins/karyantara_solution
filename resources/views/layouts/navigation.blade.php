...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    class="fixed inset-y-0 left-0 z-50 w-72 bg-[#1E293B] text-white transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto flex flex-col shadow-xl">
        ...
        <div class="p-4 border-t border-gray-700/50 bg-[#151D2A]">
            <div class="flex items-center gap-3 px-2 py-2">
                ...
                <div class="flex flex-col overflow-hidden">
                    ...
                    <span class="text-xs text-amber-500"><i class="fa-solid fa-shield-halved mr-1"></i>
                        Administrator</span>
                </div>
            </div>
        </div>
