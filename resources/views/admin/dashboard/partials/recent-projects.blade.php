<div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
    <h3 class="font-bold text-[#1E293B]"><i class="fa-solid fa-clock-rotate-left text-amber-500 mr-2"></i> Proyek Terbaru
    </h3>
...
<div class="overflow-x-auto flex-1">
    <table class="min-w-full divide-y divide-gray-100">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            @empty
                <tr>
                    <td colspan="3" class="px-6 py-8 text-center text-sm text-gray-500">Belum ada proyek ditambahkan.
                    </td>
                </tr>
            @endforelse
        </tbody>
