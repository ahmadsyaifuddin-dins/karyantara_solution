...
class TagSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $tags = [
            ...
            ['name' => 'Notif WhatsApp/Email', 'bg' => 'bg-teal-100', 'text' => 'text-teal-700'],
            ['name' => 'Ganti/Hapus Role', 'bg' => 'bg-red-800', 'text' => 'text-red-100'],
            ['name' => 'QR Code / Barcode', 'bg' => 'bg-slate-800', 'text' => 'text-slate-100'],
            ['name' => 'Maps / Titik Koordinat', 'bg' => 'bg-emerald-800', 'text' => 'text-emerald-100'],
            ...
            ['name' => 'Ganti Judul Skripsi', 'bg' => 'bg-rose-100', 'text' => 'text-rose-700'],
